[Введение 3](#_Toc216642258)

[1\. Понятие обратного проксирования и его место в сетевой архитектуре 4](#_Toc216642259)

[2\. Роль Nginx в современной веб-инфраструктуре 4](#_Toc216642260)

[2.1. Изоляция сервера приложений 4](#_Toc216642261)

[2.2. Защита от распространенных веб-атак 5](#_Toc216642262)

[2.3. Поддержка HTTPS и управление SSL/TLS 5](#_Toc216642263)

[2.4. Балансировка нагрузки и отказоустойчивость 6](#_Toc216642264)

[3\. Практическая реализация в ЛР5: детальный разбор 6](#_Toc216642265)

[3.1. Установка и базовая конфигурация 6](#_Toc216642266)

[3.2. Создание конфигурации виртуального хоста 6](#_Toc216642267)

[3.3. Активация конфигурации и управление сервисом 7](#_Toc216642268)

[3.4 Конфигурация брандмауэра 7](#_Toc216642269)

[4\. Сравнение с альтернативными решениями 7](#_Toc216642270)

[4.1. Nginx vs Apache 7](#_Toc216642271)

[4.2. Nginx vs специализированные прокси-серверы 8](#_Toc216642272)

[5\. Рекомендации для production-среды 8](#_Toc216642273)

[5.1. Полная конфигурация для production 8](#_Toc216642274)

[5.2. Регулярное обслуживание 9](#_Toc216642275)

[5.3. Резервное копирование и восстановление 10](#_Toc216642276)

[Заключение 10](#_Toc216642277)
...
**1\. Понятие обратного проксирования и его место в сетевой архитектуре**
...
**2\. Роль Nginx в современной веб-инфраструктуре**
...
**2.1. Изоляция сервера приложений**
...
**2.2. Защита от распространенных веб-атак**
...
**2.3. Поддержка HTTPS и управление SSL/TLS**
...
**2.4. Балансировка нагрузки и отказоустойчивость**
...
**3\. Практическая реализация в ЛР5: детальный разбор**
...
**3.2. Создание конфигурации виртуального хоста**
...
**3.3. Активация конфигурации и управление сервисом**
...
**4**. **Сравнение с альтернативными решениями**
...
**4.2. Nginx vs специализированные прокси-серверы**
...
**5\. Рекомендации для production-среды**

**5.1. Полная конфигурация для production**
